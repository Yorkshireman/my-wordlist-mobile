...
const config = {
  ...
  // cacheDirectory: "/private/var/folders/5t/cvc9ttps6nl4glczrcwv56b40000gn/T/jest_dx",
  ...
  // E.g. maxWorkers: 10% will use 10% of your CPU amount + 1 as the maximum worker number. maxWorkers: 2 will use a maximum of
  // 2 workers.
  // maxWorkers: "50%",
