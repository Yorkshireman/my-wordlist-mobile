...
export const useUpdateCategoriesSelectedIdsVar = wordlistCategories => {
  ...
  useEffect(() => {
    ...
    const nonOrphanedSelectedCategories = selectedCategoriesIds
      .filter(isIncludedCategoryInWordlist);
